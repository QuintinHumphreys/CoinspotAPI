...
Public Class CoinspotAPIHandler
    ...
    Public Function CallAPI(EndPoint As String, JSONParameters As String) As String
        ...
        Dim Nonce As Long = (DateTime.UtcNow - New DateTime(1970, 1, 1, 0, 0, 0)).TotalSeconds 'Math.Round((Now.ToUniversalTime() - DateTime.MinValue).TotalSeconds)
        Dim NonceParameter = """nonce""" & ":" & Nonce & IIf(Replace(JSONParameters, " ", "") = "{}", "", ",")

        'insert nonce parameter in JSON format at beginning of supplied string
        'done this way to avoid dependancies on 3rd party JSON libraries
